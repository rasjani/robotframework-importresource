...
CHANGELOG = "CHANGELOG"
filters = ["poc", "new release", "wip", "cleanup", "!nocl", "init"]
...
def docs(ctx):
    ...
    ctx.run("python -m robot.libdoc --pythonpath src ImportResource::resources=importresource-testdata docs/keywords.html")
...
def clean(ctx):
    to_be_removed = [
        ...
        "node_modules/",
        "output/",
        "src/robotframework_importresource.egg-info/",
        "output.xml",
        ".coveragedb",
        "*.html"
    ]
